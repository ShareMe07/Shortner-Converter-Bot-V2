...
START_MESSAGE = '''**Hello, {}
I Am mdiskshortners.in, Bulk Link Converter. I Can Convert Links Directly From Your mdiskshortners Account,
    
1. Go To 👉 http://mdiskshortners.in/member/tools/api  
2. Than Copy API Key
...
If You Want Any **Other Shortner** Link Converter Bot Instead Of MdiskShortener's than **contact** at 👉 @MrVenomAd (all **shortners** support available.)
'''

HELP_MESSAGE = '''**Hello, {}
I Am MdiskShortener's, Bulk Link Converter Bot. I Can Convert Links Directly From Your MdiskShorteners Account,**
    
1. Go To 👉 https://mdiskshortners.in/member/tools/api  
2. Than **Copy API** Key
3. Than Type **/api** than give a **single space** and than **paste** your **API** Key (**see example** to understand more...)
...
• I can **Convert any** links or posts to your **MdiskShorteners** link / post. (Button Links Posts, Hidden links/Hyperlinks All Are Supported)
